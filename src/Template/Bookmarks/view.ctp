...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Изменить закладку'), ['action' => 'edit', $bookmark->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Удалить закладку'), ['action' => 'delete', $bookmark->id], ['confirm' => __('Вы уверены, что хотите удалить закладку # {0}?', $bookmark->id)]) ?> </li>
